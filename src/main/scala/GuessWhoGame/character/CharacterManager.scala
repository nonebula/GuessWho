...
object CharacterManager {
  ...
  def createCharacters(): List[Character] = {
    List(
      ...
      Character("Sally", Gender.Female, HairColor.Black, EyeColor.Green, Some(PersonWithGlasses(true)), Some(PersonWithFacialHair(true))),
      Character("Spencer", Gender.Male, HairColor.Black, EyeColor.Blue, None, Some(PersonWithFacialHair(true))),
      ...
      Character("Bilal", Gender.Male, HairColor.Black, EyeColor.Green, None, Some(PersonWithFacialHair(true))),
      Character("Lisa", Gender.Female, HairColor.Black, EyeColor.Blue, Some(PersonWithGlasses(true)), None),
      Character("Tom", Gender.Male, HairColor.Black, EyeColor.Blue, Some(PersonWithGlasses(true)), None),
      Character("Cheryl", Gender.Female, HairColor.Blonde, EyeColor.Green, None, None),
      Character("Arei", Gender.Male, HairColor.Black, EyeColor.Blue, None, Some(PersonWithFacialHair(true))),
